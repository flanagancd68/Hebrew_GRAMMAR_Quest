...
|Note: You can download and install all decks now or, you may wish to start with just `Unit 1` and `Custom Words` for now. | You can load the remaining decks as you begin each new Hebrew GRAMMAR Quest unit | For those new to Anki, here is an [Anki Orientation deck](./images/Hebrew Grammar Quest_Intro_deck.apkg){target="_blank"}.  You may delete this deck when finished.
| | [Hebrew GRAMMAR Quest Unit 1 Anki Deck (version 1)](./images/HGQ_Anki_Unit1_V01.0.apkg){target="_blank"} |
