...
As we were thinking about designing the book, we noticed many similarities between preparing to travel to Israel and learning Hebrew Grammar.
...
* To get in Hebrew shape, we're not going to go to a physical gym, but there is a powerful piece of equipment that will build your Hebrew strength and endurance.  It's called Anki.  
    ...
    * There is an entire section in the Appendices devoted to [Anki](#anki_faq) if you'd like to read more. 
...
* Often, concepts you learn may not make sense until a lesson or two later.  Such "fog" is natural, and we need to go with it.
* Just like jet lag after a flight that lasts over 10 hours, we can't avoid the grammar fog entirely.  What we can do is take steps to minimize it.
    ...
    * Each lesson will have a `Quest Quiz` for you to assess your progress. We do not assign grades for this course, but if you happen to get a lower score on a `Quest Quiz`, that could indicate you aren't quite ready to move on.
    * Most lessons will have an `Equipment Check`. 
       * We want to make sure you have the right "supplies," meaning the most significant grammar concepts from the previous chapter, in your backpack before you journey forward.
* As Dr. Mounce says, if you find yourself getting discouraged, look a couple of chapters back, and you will likely realize that you are retaining more than you think you are.
...
## 3b. **Scripture**: `Verse Warm-up` videos /  Anki `Study Verses` / `Ruth Pursuits` {- }
...
We have `Ruth Pursuits` and `Study Verses` in Anki to accompany each lesson.  We will eventually link up with Hebrew Quest and read selected [`Hebrew Quest Study Passages`](https://holylanguage.com/ot-readings.html) from Hebrew Quest Lessons 17-40.
