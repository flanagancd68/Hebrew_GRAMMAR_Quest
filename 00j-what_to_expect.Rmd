...
* In Israel, things like electrical outlets and certain customs are different. The temperature difference between the Dead Sea and Jerusalem, a distance of just 70 miles, can be 30 degrees (F) or more. In the same way, Hebrew has characteristics, customs, climates that are *very* different from English.
...
* Just like jet lag after a flight that lasts over 10 hours, we can't avoid the grammar Fog entirely.  What we can do is take steps to minimize it.
    ...
    * As an additional counter-balance against The Fog, most lessons will have an `Equipment Check`. 
       * We want to make sure you have the right "supplies," meaning the most significant concepts from the previous chapter, savely in your grammar backpack before you journey forward.
...
We have `Ruth Pursuits` and `Study Verses` in Anki to accompany each lesson.  Later in the course, we will link up with Hebrew Quest and read selected [`Hebrew Quest Study Passages`](https://holylanguage.com/ot-readings.html) from Hebrew Quest Lessons 17-40.
