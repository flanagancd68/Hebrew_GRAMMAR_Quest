...
If you are eager to jump right in with Lesson 1, and skipped reading the course [Introduction](#introduction), we understand totally.  We are also excited for you to start!

The Introduction has useful information about the course, as well as a _Course Checklist_ you can download to help keep you organized and on track.
...
* `Lesson 01 C.Verses` - we won't be working on any verses just yet, but we will learn some grammar shorthand that we will use when we get to Lesson 3.
