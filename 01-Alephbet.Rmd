...
> Knowledge of the Hebrew alphabet opens the door of understanding . . . Pastor Roger Valci^[Valci, Roger. “The Hebrew Acrostic,” in <u>Basics of Biblical Hebrew: Grammar</u>, edited by Gary D Pratico and Miles V Van Pelt. Grand Rapids, MI: Zondervan. 2007.]
...
* Certain letters take what are called “Final” or “Sofit”^[_Sofit_ is just the Hebrew word for final] forms when they appear at the END of a word
...
* The names of these letters is quite simple
    ...
    * The final form is simply named Kaf Sofit ך.  Same for Mem מ and Mem sofit ם and so on^["Final Kaf", "Final Mem", etc., are also terms you may hear.]
...
* Spiritual
    ...
    * [Ruth Pursuit](https://drive.google.com/file/d/1qcfTKAlTJGChC2eYCMhSbY2w-ibzCcDV/view?usp=sharing)^[Click the link (and sign in with a Google account if necessary), then click "Open with Google Docs" to highlight the letters.]
    * Instructions:
...
* Physical - [Quest Quiz #1](https://docs.google.com/forms/d/e/1FAIpQLSeqHcE8PvfkOYbTu51cNO8sf-ln6CEnRrcTBUxM0EaeojSSsA/viewform)^[Please remember that the Quest Quizzes are intended as a checkpoint of your learning after you have completed the Physical and Spiritual Preparation ACTIVities.]
