...
|Preparation|Type|Instructions|Link
|:-----|:-----|:-----|:---|
|Physical Preparation|Anki Aerobics| Vocabulary - Learn (or relearn) the Vowels with Izzy 
||Grammar - More vowel drills.  Learn the material in the "Vocabularly" deck really well and the "Grammar" deck should go smoother.
||Worksheet |Practice writing the letters|[Vowel Writing worksheet/drill](https://drive.google.com/file/d/1ETPKE3u-XGfpNdKmlIr3P_DRbkOOlcI_/view?usp=sharing) Note: ignore the "transliteration" column.  An answer key is on page two.  Repeat this worksheet until you can complete it correctly entirely from memory.
|Spiritual | Anki Aerobics|Study-Verses - there is no translation yet but we will learn some very common Hebrew ames that we will use when we get to the study verses
|| Ruth Pursuit|1. Identify the four UNCHANGEABLE LONG vowels that use YOD in Verse 1 (blue)^[In most word processors you won't be able to isolate the vowel to highlight]|[Ruth 1 Blank Copy](https://drive.google.com/file/d/1qcfTKAlTJGChC2eYCMhSbY2w-ibzCcDV/view?usp=sharing)^[Click the link (and sign in with a Google account if necessary), then click "Open with Google Docs" to highlight the letters. ] - [(Answer Key #2)](https://drive.google.com/file/d/1xtcXRb1PWbt-qkbVWW9yGfkC40_d8gtf/view?usp=sharing)
...
|||5. One of the more common verbs in the Tanach is **וַיֹּאמֶר **, which means "(and) he said. Vav-Pathach-Yod-Daghesh Forte means "And he (did or was something)  If we change the second letter from a Yod to a Tav, we get "and **S**he (did or was something).  Thus, וַתֹּאמֶר  means "and she said".  Find the five instances of וַתֹּאמֶר in Ruth Chapter 1^[In at least three of the instances, you should be able to figure out who is speaking.]  (yellow)  
