...
* Vocal Sheva<small>^[<small>Most academic textbooks will use the term "shewa" instead of "sheva".</small>]</small>
    ...
    * Pronounced like the A in <u>A</u>muse (same as Hateph Pathach)
    * Is a REDUCED Vowel
* Silent Sheva    
    * Any letter can take a Silent Sheva
    * Silent/ No sound
    * Is NOT A Vowel
* _Both Sheva mark the **END** of a syllable
...
* Three vowel letters can take "defective" forms<small>^[<small>"Defective", in this sense, does not have a negative connotation.</small>]</small>
...
* אַתָּה = Is the Daghesh preceeded by a vowel that is not a sheva?<small>^[<small>Yes, a pathach. Daghesh Forte</small>]</small>
...
* Physical
    ...
    * Worksheet
        * Practice writing the vowels using the [Vowel Writing worksheet/drill](https://drive.google.com/file/d/1ETPKE3u-XGfpNdKmlIr3P_DRbkOOlcI_/view?usp=sharing){target="_blank"} See note<small>^[<small>ignore the "transliteration" column.  An answer key is on page two.  Repeat this worksheet until you can complete it correctly entirely from memory.]
* Spiritual
    * Anki Aerobics
