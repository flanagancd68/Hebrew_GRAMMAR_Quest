...
```{r, out.width = "400pt", fig.align='center', fig.cap="The Gutturals and Resh reject the Daghesh Forte"}

include_graphics("images/02.reject.gif")
```
...
* Spiritual
    ...
    * Ruth Pursuit [(blank copy)](https://drive.google.com/file/d/1qcfTKAlTJGChC2eYCMhSbY2w-ibzCcDV/view?usp=sharing){target="_blank"}
