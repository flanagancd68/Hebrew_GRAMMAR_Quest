...
```
<small>^[<small>As Izzy says in Hebrew Quest, “Vowels are important.”  On your screen, you see Genesis 1:9.  The black font shows the text with no vowels. Over time, vowel notation was developed by the Masorites. These are the symbols in red.  These are usually under, but sometimes in the middle of or over the affected consonant. This vowel system intends to preserve the pronunciation passed down for centuries via the oral tradition. The Hebrew name for these diacritical dots and dashes is _nikudot_. The blue font shows additional cantillation marks, which are used for chanting the verses.  These marks also show where the word's accent is.  
...
1. Meet ["defective" and "plene" spelling](#two_4) 
...
Like the Aleph-bet, we are merely going to have to commit the table below to memory.
...
### Both are written as בְּ |   VOCAL Sheva is a REDUCED vowel | SILENT Sheva is NOT A Vowel {-}
...
## "Defective" and "plene" spelling {#two_4}
...
### "A Daghesh is a Forte if, and only if, it's preceded by a vowel <small>^[<small>Remember the rule for the Daghesh Lene?  See Lesson 1.4</small>]</small>that is not a Sheva." ---John Beckman {-}
...
* עַל־פְּנֵי = Is the Daghesh preceded by a vowel that is not a Sheva?<small>^[<small>No. Daghesh Lene.  The "hyphen" looking mark is called a Maqquef.  It has the exact same function as the Hyphen does in English.</small>]</small>
...
* A large chunk of Hebrew GRAMMAR Quest will involve our learning to resolve these situations - more to come!
