...
1. Learn the two basic concepts of [Hebrew Syllables](#syllables)
1. Learn the rules and terminology related to [Hebrew Word Accents](#accents)
1. Know the Three Rules for Recognizing [Silent Sheva](#s_sheva)
1. Know the Four RulesRecognizing Vocal Sheva: Four Rules Gutturals Reject [Vocal Sheva](#v_sheva)
1. Learn the primary [Hebrew Diphthong](#diphthong)
1. Understand [Vowels and Syllable Preference](#vowel_pref)
1. Learn three simple miscellaneous concepts: [Qamets and Qamets Hatuf, Furtive Patach Quiescent Alef](#misc_vowels)

### `Lesson Prayer` {-}

Pray for anything that has you you worried or anxious.
...
[Click to open `Word Warm-up` video in a new tab](https://www.youtube.com/embed/D0uG3_PTzGA){target="_blank"}

<iframe width="768" height="432" src="https://www.youtube.com/embed/D0uG3_PTzGA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
[Click to open `Verses Warm-up` video in a new tab](https://www.youtube.com/embed/_BD0WD2cQ7c){target="_blank"}

<iframe width="768" height="432" src="https://www.youtube.com/embed/_BD0WD2cQ7c" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## `Anki Aerobics` {-}

* `Lesson 03 A.Vocab` - This is our first lesson with the <u>Basics of Biblical Hebrew</u> vocabulary list.
* `Lesson 03 B.Grammar` - This module will reenforce and expand on the Seven Practical Points for this lesson.
* `Lesson 03 C.Verses`
  * This is also the verse lesson using the <u>Basics of Biblical Hebrew</u> study verses.
  * The translation may be difficult at first, and it may take you several attempts before you can select `Good` without using the `Hints`.
  * Be patient and stick with it - you'll get it!
  
Use your laptop or mobile device or the web version below
``` {r}
knitr::include_url('https://ankiweb.net/decks/', height = '800px')
```

<iframe src="https://ankiweb.net/decks/" width="800" height="600" frameborder="2" marginheight="0" marginwidth="0"></iframe>
...
``` {r}
knitr::include_url('https://docs.google.com/forms/d/e/1FAIpQLSfCy3m3L8z1a5EjEMtEBVWjoci-JvWfYzUVEIpnQHIgGwvu1g/viewform', height = '800px')
```
