...
1. [Download and Install the Anki Program (Mac/PC/Linux)](https://apps.ankiweb.net/){target="_blank"}
    * If you do not have access to a desktop/laptop computer to install Anki, but do have access to a mobile device, we can help.
    * Contact us for assistance at holylanguagecourses at gmail dot com.
...
## How do I access the Anki Hebrew GRAMMAR Quest deck? {-}
...
After you have installed Anki, loaded a deck and then synched to your Ankiweb account, theorhetically, you do not ever need to access the non-mobile version again.

There are versions of the mobile app in the Google or Apple store.  As we mentioned above, the apple version is a one-time cost of $25 (worth the cost in our opinion). Once you download the app, you can login with your same Ankiweb account and, if you synched from the desktop version of the software, you should see the Hebrew GRAMMAR Quest deck appear.

You can also access a [web-based version of Anki (login with your Ankiweb credentials)](https://ankiweb.net/decks/).  Functionality is a bit more limited, but it is generally sufficient.  
