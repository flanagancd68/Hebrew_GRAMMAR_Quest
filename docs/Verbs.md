...
# X Introduction to Hebrew Verbs {#Verbs}
...
1. Components of a Verb
1. Person, Gender, Number
1. The Seven Stems
1. The eight basic aspects within each stem
...
<p class="caption">(\#fig:unnamed-chunk-2)Judean Wilderness. Courtesy of the [Pictorial Library of Bible Lands](https://www.bibleplaces.com)</p>
</div>



## X Components of a Verb
