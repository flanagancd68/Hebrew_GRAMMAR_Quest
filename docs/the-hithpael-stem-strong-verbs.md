...
<p class="caption">(\#fig:unnamed-chunk-2)Men Praying at Western Wall. Courtesy of the [Pictorial Library of Bible Lands](https://www.bibleplaces.com)</p>
</div>
...
* **יִתְקַטֶּל*** - tDI3ms, and so forth for the remaining imperfect stems. 
    * tDI1cs preformative is **אֶתְ***
* **מִתְקַטֶּל*** - tDPtms

* Preformative always has ** תְ ִ *** (except for I1cs)
* $R_2$ takes Daghesh Forte
*  $V_S$ = Ē[A] ~ Ē
    * tDP2ms and tDP1cs have $V_S$ = ַ , otherwise it'sֵ  very consistently

> The Preformative is Enough to Identify tD Stem
...
There is no "B. Grammar" module for this lesson.
    
## OPTIONAL: Hitpael Parsing Worksheet {-}

If you desire additional paradigm practice, you may use this worksheet.

[Name of worksheet](./images/34_hithpael_strong_paradigms.pdf){target="_blank"}
