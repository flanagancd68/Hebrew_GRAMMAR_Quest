...
* The Hitpael verb WILL lose if $R_2$ is Guttural or Resh
    ...
    * With א and ר $V_1$ will lengthen from Patach to Qamets
        * **הִתְבָּרֵךְ*** tDP3ms of ברך, "he blessed himself"


## Transposition of ת and $R_1$ when $R_1$ is sibilant

* The sibilants are the same letters as the "S" SQiN eM LeVY letters
* The ancients found it easier to pronounce **הִשְׁתַּמֵּר**** instead of **הִתְשַׁמֵּר***
...
* Examples:
    * **הִסְתַּתֵּר*** - he hid himself
    * **הִשְׂתַּכֵּר*** - he earned wages for (hired) himself<small>^[<small>BBH mentions that there are three times n the Bible when $R_1$ = **צ***, not only will the **ת*** switch places, it will change to **ט***.</small>]</small>


## Preformative תְ assimilates when $R_1$ is ז ד ט ת,

* If $R_1$ is ז ד ט ת, the ת of the Hithpael preformative will assimilate into $R_1$ and remain as a Daghesh Forte
...
*  **חוה*** gets it's own stem: Hishtapel
*  **חוה*** only occurs in the Hishtapel
*  **חוה*** means: to prostrate oneself in worship (as to God, or another diety) or submission (as to a king)
* **הִשְׁתַּחוָה*** - HstP3ms - he worshipped
* **יִשְׁתַּח*** - HstI3ms - he will worship
* ***** - Hst(P3cp/M2mp) - worship! or they will worship
* ***** - HstP3ms - to worship
* ***** - HstP3ms - worshipping
## X Point4 
